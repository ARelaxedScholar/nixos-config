    ...
    programs.niri = {
      ...
      settings = {
        binds =
          ...
          {
            # First Key Row
            "Mod+Space".action = spawn "${pkgs.rofi-wayland}/bin/rofi" "-show" "drun";
            "Mod+W".action = spawn "${pkgs.kitty}/bin/kitty";
            "Mod+E".action = spawn "${pkgs.firefox}/bin/firefox";
            "Mod+R".action = close-window;
